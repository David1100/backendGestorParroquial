...
@Controller('parroquias/:parroqusiaId/matrimonios')
@UseGuards(JwtAuthGuard, PermissionGuard)
export class MatrimoniosController {
  constructor(private service: MatrimoniosService) {}

  @Get()
  @Permission('matrimonios', 'ver')
  ...
  @Delete(':id')
  @Permission('matrimonios', 'eliminar')
