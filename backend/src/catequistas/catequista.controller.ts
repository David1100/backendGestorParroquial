...
@Controller('parroquias/:parroqusiaId/catequistas')
@UseGuards(JwtAuthGuard, PermissionGuard)
export class CatequistaController {
  constructor(private service: CatequistaService) {}

  @Get()
  @Permission('catequistas', 'ver')
  ...
  @Delete(':id')
  @Permission('catequistas', 'eliminar')
