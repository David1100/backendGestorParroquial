...
@Controller('parroquias/:parroqusiaId/confirmaciones')
@UseGuards(JwtAuthGuard, PermissionGuard)
export class ConfirmacionesController {
  constructor(private service: ConfirmacionesService) {}

  @Get()
  @Permission('confirmaciones', 'ver')
  ...
  @Delete(':id')
  @Permission('confirmaciones', 'eliminar')
