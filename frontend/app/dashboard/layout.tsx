...
const menuSections = [
  ...
  },
  {
    ...
    paths: ['/dashboard/parroquias', '/dashboard/usuarios', '/dashboard/perfiles', '/dashboard/quienfirma', '/dashboard/grupos', '/dashboard/catequistas'],
  },
  {
    id: 'registros',
